...
import { asyncForEach } from '../utils/async_foreach';
...
export class ProductsService {
  ...
  async updateWithImages(
    ...
    if (
      !product.image_to_update ||
      !Array.isArray(product.image_to_update) ||
      product.image_to_update.length === 0
    ) {
      throw new HttpException(
        'Las imágenes a actualizar son obligatorias',
